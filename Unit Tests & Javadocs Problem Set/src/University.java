...
public class University {
	...
	public void printStatus() throws InvalidIdException, InvalidDurationException, InvalidWeightException {
	...
	public void CreateUnits() throws InvalidIdException, InvalidDurationException, InvalidWeightException {
		
		unitArrayList.add(new Unit(new AssessmentScheme(new Exam(50,50), new Assignment(50, "Assignment1")), "FIT1234", "Advanced Bogosorts"));
		unitArrayList.add(new Unit(new AssessmentScheme(new Exam(60, 45), new Assignment(40, "Assignment2")), "FIT2027", "Introduction to Spaghetti Coding"));
		unitArrayList.add(new Unit(new AssessmentScheme(new Exam(65,55), new Assignment(35, "Assigment3")), "FIT3456", "Enterprise Fizzbuzz"));
	...
	int total_mark = 0;
	public int studentMark(AssessmentScheme a, Student s){
		for(int i = 0; i < a.getAssessmentSchemeList().size(); i++){
			total_mark += a.getAssessmentSchemeList().get(i).marks.get(s.studentId).getMark();
		}
		return total_mark;
	}
